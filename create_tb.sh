...
(
    ...
    n_comment    STRING
) ${storage} ClUSTER BY (n_nationkey) ${options}" | bendsql
...
(
    ...
    r_comment    STRING
) ${storage} ClUSTER BY (r_regionkey) ${options}" | bendsql
...
) ${storage} ClUSTER BY (p_partkey) ${options}" | bendsql
...
) ${storage} ClUSTER BY (s_suppkey) ${options}" | bendsql
...
) ${storage} ClUSTER BY (ps_partkey) ${options}" | bendsql
...
) ${storage} ClUSTER BY (c_custkey) ${options}" | bendsql
...
) ${storage} ClUSTER BY (o_orderkey, o_orderdate) ${options}" | bendsql
